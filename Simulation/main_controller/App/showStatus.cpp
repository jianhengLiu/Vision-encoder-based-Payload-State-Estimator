...
//    printf("\x1b[%d;%dm%s\x1b[%dm", 1, 2, 3);
    ...
    while(ros::ok()){
        ...
        if(dis(vicon_pos, mavros_pos) < 0.05){
            printf("\033[45;32m|  Mavros     : (%.4lf,%.4lf,%.4lf)                                               \n", (double)mavros_pos.x(),(double)mavros_pos.y(),(double)mavros_pos.z());
        }

        else{
            printf("\033[45;31m|  Mavros     : (%.4lf,%.4lf,%.4lf)                                               \n", (double)mavros_pos.x(),(double)mavros_pos.y(),(double)mavros_pos.z());
